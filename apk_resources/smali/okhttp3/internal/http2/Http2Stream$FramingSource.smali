...
.method public final receive$okhttp(Lokio/BufferedSource;J)V
    ...
    .line 452
    .local v12, "$i$a$-synchronized-Http2Stream$FramingSource$receive$2":I
    :try_start_1
    iget-boolean v13, v1, Lokhttp3/internal/http2/Http2Stream$FramingSource;->closed:Z
    ...
    invoke-virtual {v6, v13}, Lokio/Buffer;->writeAll(Lokio/Source;)J
    ...
    .end local v12    # "$i$a$-synchronized-Http2Stream$FramingSource$receive$2":I
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
