...
.method public static final commonIndexOf(Lokio/Buffer;BJJ)J
    ...
    .local v28, "$i$a$-seek--Buffer$commonIndexOf$2":I
    int-to-long v9, v9
    ...
    .line 1311
    iget-object v13, v5, Lokio/Segment;->next:Lokio/Segment;
    ...
    .line 1314
    .end local v22    # "s":Lokio/Segment;
    .end local v28    # "$i$a$-seek--Buffer$commonIndexOf$2":I
    .end local v29    # "$this$seek$iv":Lokio/Buffer;
    .end local v30    # "$i$f$seek":I
    .local v9, "s":Lokio/Segment;
    .local v10, "$i$a$-seek--Buffer$commonIndexOf$2":I
    .restart local v13    # "$this$seek$iv":Lokio/Buffer;
    ...
    .line 1802
    iget-object v13, v15, Lokio/Segment;->next:Lokio/Segment;
    ...
    .end local v10    # "$i$a$-seek--Buffer$commonIndexOf$2":I
    .local v26, "$i$a$-seek--Buffer$commonIndexOf$2":I
    int-to-long v9, v9

    move-wide/from16 v27, v11

    .end local v11    # "fromIndex$iv":J
    .local v27, "fromIndex$iv":J
    ...
    .end local v26    # "$i$a$-seek--Buffer$commonIndexOf$2":I
    .end local v27    # "fromIndex$iv":J
    .local v9, "s":Lokio/Segment;
    .local v10, "$i$a$-seek--Buffer$commonIndexOf$2":I
    .restart local v11    # "fromIndex$iv":J
    :cond_e
    move-object/from16 v24, v9
...
.method public static final commonIndexOf(Lokio/Buffer;Lokio/ByteString;J)J
    ...
    .line 1812
    iget-object v7, v11, Lokio/Segment;->prev:Lokio/Segment;
    ...
    .end local v7    # "$i$a$-seek--Buffer$commonIndexOf$5":I
    .local v28, "$i$a$-seek--Buffer$commonIndexOf$5":I
    int-to-long v6, v6
    ...
    invoke-static {v3, v6, v12, v10, v2}, Lokio/internal/-Buffer;->rangeEquals(Lokio/Segment;I[BII)Z
    ...
    .line 1346
    iget-object v6, v3, Lokio/Segment;->next:Lokio/Segment;
    ...
    .end local v28    # "$i$a$-seek--Buffer$commonIndexOf$5":I
    .end local v30    # "$i$f$seek":I
    ...
    .local v23, "resultLimit":J
    :goto_6
    cmp-long v16, v12, v23
    ...
    .end local v7    # "$i$a$-seek--Buffer$commonIndexOf$5":I
    .local v6, "a$iv":I
    .local v26, "$i$a$-seek--Buffer$commonIndexOf$5":I
    ...
    .end local v1    # "segmentLimit":I
    .end local v5    # "data":[B
    goto :goto_6

    .line 1349
    .end local v16    # "offset":J
    .end local v26    # "$i$a$-seek--Buffer$commonIndexOf$5":I
    .end local v27    # "fromIndex$iv":J
    .local v5, "offset":J
    .local v7, "$i$a$-seek--Buffer$commonIndexOf$5":I
...
.method public static final commonIndexOfElement(Lokio/Buffer;Lokio/ByteString;J)J
    ...
    .end local v8    # "$i$a$-seek--Buffer$commonIndexOfElement$2":I
    .local v25, "$i$a$-seek--Buffer$commonIndexOfElement$2":I
    int-to-long v7, v7
    ...
    .end local v25    # "$i$a$-seek--Buffer$commonIndexOfElement$2":I
    .local v7, "s":Lokio/Segment;
    .local v8, "$i$a$-seek--Buffer$commonIndexOfElement$2":I
    :cond_7
    move-object/from16 v18, v7
    ...
    .restart local v25    # "$i$a$-seek--Buffer$commonIndexOfElement$2":I
    ...
    .line 1401
    .end local v27    # "fromIndex":J
    .local v7, "fromIndex":J
    :cond_b
    move-wide/from16 v27, v7

    .end local v7    # "fromIndex":J
    .restart local v27    # "fromIndex":J
    ...
    .line 1842
    iget-object v9, v11, Lokio/Segment;->next:Lokio/Segment;
    ...
    .line 1358
    .local v10, "$i$a$-seek--Buffer$commonIndexOfElement$2":I
    if-nez v7, :cond_f
    ...
    .line 1369
    iget-object v0, v12, Lokio/Segment;->data:[B
    ...
    .restart local v25    # "b0":B
    .restart local v27    # "b1":B
    iget v0, v12, Lokio/Segment;->limit:I
    ...
    .line 1383
    iget-object v0, v12, Lokio/Segment;->next:Lokio/Segment;
    ...
    .end local v10    # "$i$a$-seek--Buffer$commonIndexOfElement$2":I
    .end local v11    # "s$iv":Lokio/Segment;
...
.method public static final commonReadUtf8LineStrict(Lokio/Buffer;J)Ljava/lang/String;
    ...
    .line 877
    .local v0, "$i$f$commonReadUtf8LineStrict":I
    const-wide/16 v1, 0x0
    ...
    .line 877
    .local v1, "$i$a$-require--Buffer$commonReadUtf8LineStrict$1":I
    new-instance v2, Ljava/lang/StringBuilder;
    ...
    .end local v1    # "$i$a$-require--Buffer$commonReadUtf8LineStrict$1":I
    new-instance v2, Ljava/lang/IllegalArgumentException;
