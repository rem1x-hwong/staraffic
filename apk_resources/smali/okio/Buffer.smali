...
.method public indexOf(BJJ)J
    ...
    .local v23, "$i$a$-seek--Buffer$commonIndexOf$2$iv":I
    ...
    .end local v23    # "$i$a$-seek--Buffer$commonIndexOf$2$iv":I
    ...
    .restart local v23    # "$i$a$-seek--Buffer$commonIndexOf$2$iv":I
    ...
    .line 1555
    .local v14, "$i$a$-seek--Buffer$commonIndexOf$2$iv":I
    if-nez v2, :cond_b
    ...
    .end local v13    # "s$iv$iv":Lokio/Segment;
    .end local v14    # "$i$a$-seek--Buffer$commonIndexOf$2$iv":I
...
.method public indexOf(Lokio/ByteString;J)J
    ...
    .line 1602
    .local v13, "$i$a$-seek--Buffer$commonIndexOf$5$iv":I
    if-nez v12, :cond_4
    ...
    .local v27, "s$iv$iv":Lokio/Segment;
    int-to-long v10, v1
    ...
    .end local v13    # "$i$a$-seek--Buffer$commonIndexOf$5$iv":I
    .local v29, "s$iv":Lokio/Segment;
    .local v30, "$i$a$-seek--Buffer$commonIndexOf$5$iv":I
    int-to-long v12, v5
    ...
    invoke-static {v10, v12, v7, v13, v1}, Lokio/internal/-Buffer;->rangeEquals(Lokio/Segment;I[BII)Z
    ...
    .end local v30    # "$i$a$-seek--Buffer$commonIndexOf$5$iv":I
    .end local v31    # "offset$iv$iv":J
    .local v2, "$i$f$commonIndexOf":I
    .local v5, "$this$seek$iv$iv":Lokio/Buffer;
    .local v12, "s$iv":Lokio/Segment;
    .restart local v13    # "$i$a$-seek--Buffer$commonIndexOf$5$iv":I
    .restart local v14    # "offset$iv$iv":J
    :cond_7
    move/from16 v21, v2
    ...
    .restart local v30    # "$i$a$-seek--Buffer$commonIndexOf$5$iv":I
    ...
    .end local v27    # "s$iv$iv":Lokio/Segment;
    .end local v28    # "$this$seek$iv$iv":Lokio/Buffer;
    .end local v29    # "s$iv":Lokio/Segment;
    .end local v30    # "$i$a$-seek--Buffer$commonIndexOf$5$iv":I
    .end local v31    # "offset$iv$iv":J
    ...
    .local v8, "a$iv$iv":I
    .local v16, "$this$commonIndexOf$iv":Lokio/Buffer;
    ...
    .line 1628
    .end local v16    # "$this$commonIndexOf$iv":Lokio/Buffer;
    ...
    .end local v12    # "offset$iv":J
    .local v11, "targetByteArray$iv":[B
    .restart local v16    # "$this$commonIndexOf$iv":Lokio/Buffer;
    ...
    .end local v24    # "fromIndex$iv$iv":J
    .end local v26    # "$i$f$seek":I
    .end local v28    # "$this$seek$iv$iv":Lokio/Buffer;
    .end local v29    # "offset$iv":J
    :goto_8
...
.method public indexOfElement(Lokio/ByteString;J)J
    ...
    .end local v8    # "$i$a$-seek--Buffer$commonIndexOfElement$2$iv":I
    .local v23, "$i$a$-seek--Buffer$commonIndexOfElement$2$iv":I
    ...
    .line 1665
    .local v9, "pos$iv":I
    iget v8, v15, Lokio/Segment;->limit:I
    ...
    .end local v17    # "b0$iv":B
    .end local v23    # "$i$a$-seek--Buffer$commonIndexOfElement$2$iv":I
    .end local v24    # "$this$seek$iv$iv":Lokio/Buffer;
    .restart local v2    # "b0$iv":B
    .local v7, "s$iv":Lokio/Segment;
    .local v8, "$i$a$-seek--Buffer$commonIndexOfElement$2$iv":I
    ...
    .restart local v17    # "b0$iv":B
    .restart local v23    # "$i$a$-seek--Buffer$commonIndexOfElement$2$iv":I
    .restart local v24    # "$this$seek$iv$iv":Lokio/Buffer;
    .restart local v25    # "fromIndex$iv":J
    goto/16 :goto_8
    ...
    .end local v29    # "t$iv":B
    .restart local v2    # "targetByteArray$iv":[B
    .restart local v3    # "t$iv":B
    :cond_9
    move-object/from16 v28, v2
    ...
    .line 1652
    .local v9, "$i$a$-seek--Buffer$commonIndexOfElement$2$iv":I
    if-nez v2, :cond_f
    ...
    .line 1663
    iget-object v0, v15, Lokio/Segment;->data:[B
    ...
    .line 1665
    .local v6, "pos$iv":I
    iget v5, v15, Lokio/Segment;->limit:I
    ...
    .line 1662
    .end local v16    # "fromIndex$iv$iv":J
    .end local v21    # "b0$iv":B
    .restart local v2    # "b0$iv":B
    .local v5, "fromIndex$iv$iv":J
    :cond_13
    ...
    .end local v3    # "fromIndex$iv":J
    .end local v5    # "fromIndex$iv$iv":J
    .restart local v16    # "fromIndex$iv$iv":J
    .restart local v21    # "b0$iv":B
    .restart local v25    # "fromIndex$iv":J
    move-object v12, v1
    ...
    .end local v25    # "fromIndex$iv":J
    .restart local v3    # "fromIndex$iv":J
    .restart local v5    # "fromIndex$iv$iv":J
    :cond_14
    move-wide/from16 v16, v5
    ...
    .local v12, "$this$commonIndexOfElement$iv":Lokio/Buffer;
    int-to-long v1, v6
    ...
    .line 1682
    .end local v12    # "$this$commonIndexOfElement$iv":Lokio/Buffer;
    .end local v27    # "targetByteArray$iv":[B
    .restart local v0    # "targetByteArray$iv":[B
    .local v1, "$this$commonIndexOfElement$iv":Lokio/Buffer;
    :cond_18
    ...
    .end local v0    # "targetByteArray$iv":[B
    .end local v1    # "$this$commonIndexOfElement$iv":Lokio/Buffer;
    .restart local v12    # "$this$commonIndexOfElement$iv":Lokio/Buffer;
    :goto_10
    const-wide/16 v12, -0x1
    ...
    .end local v3    # "fromIndex$iv":J
    .end local v7    # "offset$iv$iv":J
    .end local v9    # "$i$a$-seek--Buffer$commonIndexOfElement$2$iv":I
    .end local v10    # "$i$f$seek":I
    .end local v11    # "s$iv$iv":Lokio/Segment;
    .end local v12    # "$this$commonIndexOfElement$iv":Lokio/Buffer;
